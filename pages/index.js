      ...
      <div className="container">
        ...
        <div className="hero">
          <div className="container01">
            <div
              className="card mobile-first-div"
              style={{
                height: "auto;",
              }}
            >
              ...
              <div
                className="container04 flex-wrap-mobile"
                style={{
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
        ...
        <section className="container07">
          <div className="container08 mobile-padding">
            ...
            <span className="text04">
              <span
                className="text05"
                style={{ textAlign: "justify !important", display: "flex" }}
              >
                As a Producer, Artist and Songwriter, Alex Plays has travelled
                the world with many global artists from all walks of life. Music
                is at the center of what can positively change the world. Alex
                Plays Music that sets you free. He plays music for you.
              </span>
            </span>
          </div>
              ...
              <section className="contaier">
                ...
                <div style={{ width: "100%", padding: "0" }}>
                  <TwitterTimelineEmbed
                    ...
                    options={{ height: "860px", width: "100%" }}
                  />
                </div>
              </section>
              {/* <Footer></Footer> */}
